...
interface SupabaseAssignmentEditorProps {
  courseId: string;
  canEdit: boolean;
}

const SupabaseAssignmentEditor = ({ courseId, canEdit }: SupabaseAssignmentEditorProps) => {
  ...
  const { assignments, createAssignment, updateAssignment, deleteAssignment } = useSupabaseData();
...
export default SupabaseAssignmentEditor;
